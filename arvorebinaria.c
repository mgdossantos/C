...
int consultaArvBinRecursivo(arvBin *raiz, int valor);
int menorElementoArvBin(arvBin *raiz);
int maiorElementoArvBin(arvBin *raiz);
...
int main(){
    ...
    //preOrdemArvBin(raiz);
    // posOrdemArvBin(raiz);
	//int encontrado=consultaArvBinRecursivo(raiz,12);
    //if(encontrado==1)
    //    printf("Encontrei\n");
    //else
    //    printf("Naum encontrei\n");
    int menor=menorElementoArvBin(raiz);
    printf("Menor: %d\n",menor);
    int maior=maiorElementoArvBin(raiz);
    printf("Maior: %d\n",maior);
    return(0);
}
...
int consultaArvBinRecursivo(arvBin *raiz, int valor){
    ...
    if(*raiz!=NULL){
        if (valor==(*raiz)->info)
            ...
            if(valor<(*raiz)->info){
                consultaArvBinRecursivo(&((*raiz)->esq),valor);
            }
            else{
                consultaArvBinRecursivo(&((*raiz)->dir),valor);
            }    
        }
    }
}
